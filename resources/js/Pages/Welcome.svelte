                    ...
                    {#each services as service, i}
                        <div use:scrollReveal={{ delay: i * 100 }} class="group relative bg-slate-900 border border-slate-800 p-8 lg:p-10 rounded-[2.5rem] transition-all duration-500 hover:border-sky-500/30 shadow-2xl overflow-hidden flex flex-col reveal">
                            ...
                            <div class="flex-1 mb-8">
                                <p class="text-base text-slate-400 leading-relaxed font-light group-hover:text-slate-300 transition-colors whitespace-pre-line text-justify">
                                    {service.description}
                                </p>
                            </div>
                            ...
                            <div class="mt-auto relative z-20">
                                <a 
                                    ...
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    class="w-full flex items-center justify-center gap-2 bg-slate-800/50 hover:bg-[#25D366] text-white px-6 py-4 rounded-xl font-bold transition-all duration-300 group/btn border border-slate-700 hover:border-[#25D366]"
                                >
