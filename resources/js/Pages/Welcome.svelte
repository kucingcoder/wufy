                ...
                <div use:scrollReveal={{ delay: 200 }} class="min-w-[240px] reveal">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-sky-500 text-[10px] font-black uppercase tracking-[0.2em] mb-1">Lokasi</p>
                                <p class="text-white text-lg font-bold tracking-tight">{profile?.city}, {profile?.province}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-sky-500 text-[10px] font-black uppercase tracking-[0.2em] mb-1">Telepon</p>
                                <p class="text-white text-lg font-bold tracking-tight">{profile?.phone}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <p class="text-sky-500 text-[10px] font-black uppercase tracking-[0.2em] mb-1">Email</p>
                                <p class="text-white text-lg font-bold tracking-tight">{profile?.email}</p>
                            </div>
                        </div>
                    </div>
                </div>
