...
<div class="bg-[#020617] text-slate-100 font-['Plus_Jakarta_Sans'] selection:bg-sky-500/30 min-h-screen overflow-x-hidden">
    ...
    <main class="pt-32 pb-40 px-6 relative z-10">
        <article class="container mx-auto max-w-5xl">
                ...
                <div class="flex flex-wrap items-center gap-6">
                    ...
                    {#if project.is_opensource && project.github_link}
                        <a 
                            ...
                            class="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 hover:text-white hover:border-sky-500/50 transition-all group shadow-xl"
                        >
                            ...
                            <span class="text-xs font-bold uppercase tracking-wider">View Source</span>
                        </a>
                    {/if}
                </div>
            </div>
            ...
            <!-- Main Image -->
            <div class="relative rounded-[3rem] overflow-hidden bg-slate-900 border border-slate-800 mb-20 shadow-2xl group">
